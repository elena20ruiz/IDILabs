...
{	
    ...
    //Calcul de la matriu: inversa de la transpose (view*TG)
    mat3 normalMatrix = inverse (transpose (mat3 (view * TG)));
    //On va la reflexio de la llum
    vec3 normalSCO =  normalize(normalMatrix * normal);

    //La direccio del focus: projeccio de la camera + Configuracio del viewport + posiciodel focus
    vec4 focusSCO = proj*view * vec4(posFocus,1.0);
